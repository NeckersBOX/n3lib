...
{\em arg} & Pointer to an itialized \mbox{\hyperlink{struct____n3l__backward__data}{\+\_\+\+\_\+n3l\+\_\+backward\+\_\+data}} struct \\
\hline
\end{DoxyParams}
...
The member {\ttfamily net-\/$>$targets} must be initialized before calling this function. Each call to the previous layer from the last layer is execute with concurrents threads.
